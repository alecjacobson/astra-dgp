...
for v in views:
 ...
 if v.startswith('video_'):s.view_settings.exposure={'video_1452':-1.25,'video_1430':-1.1,'video_0330':.55,'video_0030':-.35,'video_0730':-.35}.get(v,-.75)
 s.render.resolution_y=round(s.render.resolution_x*(9/16 if v.startswith('video_') else 5/7))
