...
import base64
P=Path(__file__).resolve().parents[1];template=(P/'viewer/template.html').read_text();bundle=(P/'viewer/bundle.js').read_text();data=base64.b64encode((P/'viewer/bahen-lit.glb').read_bytes()).decode()
